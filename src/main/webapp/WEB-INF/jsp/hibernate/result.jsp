...
<%@ page import="com.maistruk.model.hibernate.*"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<body>
	...
	<form action="/spring_hibernate_java_quiz" >
	    ...
	    List<HibernateQuestionAnswer> questionAnswerList = (ArrayList<HibernateQuestionAnswer>) session.getAttribute("hibernateQuestionAnswerList");
			...
			for(HibernateAnswerFlags answerFlags : answerFlagsList){
	...
	<%
		    int questionNum = 0;
					for(HibernateQuestionAnswer questionAnswer : questionAnswerList){
					    HibernateAnswerFlags answerFlags = answerFlagsList.get(questionNum);
					    questionNum++;
