...
<%@ page import="com.maistruk.model.web.*"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<form action="/spring_hibernate_java_quiz" >
	    ...
	    List<WebQuestionAnswer> questionAnswerList = (ArrayList<WebQuestionAnswer>) session.getAttribute("webQuestionAnswerList");
			...
			for(WebAnswerFlags answerFlags : answerFlagsList){
	...
	<%
		    int questionNum = 0;
					for(WebQuestionAnswer questionAnswer : questionAnswerList){
					    WebAnswerFlags answerFlags = answerFlagsList.get(questionNum);
					    questionNum++;
