...
<%@ page import="com.maistruk.model.servlet.*"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<form action="/spring_hibernate_java_quiz" >
	    ...
	    List<ServletQuestionAnswer> questionAnswerList = (ArrayList<ServletQuestionAnswer>) session.getAttribute("servletQuestionAnswerList");
			...
			for(ServletAnswerFlags answerFlags : answerFlagsList){
	...
	<%
		    int questionNum = 0;
					for(ServletQuestionAnswer questionAnswer : questionAnswerList){
					    ServletAnswerFlags answerFlags = answerFlagsList.get(questionNum);
					    questionNum++;
