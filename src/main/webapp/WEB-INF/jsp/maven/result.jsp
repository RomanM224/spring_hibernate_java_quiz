...
<%@ page import="com.maistruk.model.maven.*"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<form action="/spring_hibernate_java_quiz" >
	    ...
	    List<MavenQuestionAnswer> questionAnswerList = (ArrayList<MavenQuestionAnswer>) session.getAttribute("mavenQuestionAnswerList");
			...
			for(MavenAnswerFlags answerFlags : answerFlagsList){
	...
	<%
		    int questionNum = 0;
					for(MavenQuestionAnswer questionAnswer : questionAnswerList){
					    MavenAnswerFlags answerFlags = answerFlagsList.get(questionNum);
					    questionNum++;
