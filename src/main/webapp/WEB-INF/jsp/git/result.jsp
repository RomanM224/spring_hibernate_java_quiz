...
<%@ page import="com.maistruk.model.git.*"%>
<!DOCTYPE html>
<html>
<head>
<meta charset="UTF-8">
...
<form action="/spring_hibernate_java_quiz" >
	    ...
	    List<GitQuestionAnswer> questionAnswerList = (ArrayList<GitQuestionAnswer>) session.getAttribute("gitQuestionAnswerList");
			...
			for(GitAnswerFlags answerFlags : answerFlagsList){
	...
	<%
		    int questionNum = 0;
					for(GitQuestionAnswer questionAnswer : questionAnswerList){
					    GitAnswerFlags answerFlags = answerFlagsList.get(questionNum);
					    questionNum++;
