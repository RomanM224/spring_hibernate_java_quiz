...
public class SqlAnswerFlags {
    ...
    public String toString() {
        return "SqlAnswerFlags [id=" + id + ", answerFlag1=" + answerFlag1 + ", answerFlag2=" + answerFlag2
    ...
    public void setFlags(SqlQuestionAnswer questionAnswer) {
