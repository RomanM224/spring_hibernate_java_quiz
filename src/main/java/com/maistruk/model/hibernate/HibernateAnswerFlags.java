...
public class HibernateAnswerFlags {
    ...
    public String toString() {
        return "HibernateAnswerFlags [id=" + id + ", answerFlag1=" + answerFlag1 + ", answerFlag2=" + answerFlag2
    ...
    public void setFlags(HibernateQuestionAnswer questionAnswer) {
