...
public class JavaCoreAnswerFlags {
    ...
    public String toString() {
        return "JavaCoreAnswerFlags [id=" + id + ", answerFlag1=" + answerFlag1 + ", answerFlag2=" + answerFlag2
    ...
    public void setFlags(JavaCoreQuestionAnswer javaCoreQuestionAnswer) {
        id = javaCoreQuestionAnswer.getJavaCoreQuestion().getId();
        answerFlag1 = javaCoreQuestionAnswer.getJavaCoreAnswer1().getFlag();
        answerFlag2 = javaCoreQuestionAnswer.getJavaCoreAnswer2().getFlag();
        answerFlag3 = javaCoreQuestionAnswer.getJavaCoreAnswer3().getFlag();
        answerFlag4 = javaCoreQuestionAnswer.getJavaCoreAnswer4().getFlag();
    }
