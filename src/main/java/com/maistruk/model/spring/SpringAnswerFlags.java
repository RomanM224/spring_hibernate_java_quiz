...
public class SpringAnswerFlags {
    ...
    public String toString() {
        return "SpringAnswerFlags [id=" + id + ", answerFlag1=" + answerFlag1 + ", answerFlag2=" + answerFlag2
    ...
    public void setFlags(SpringQuestionAnswer springQuestionAnswer) {
        id = springQuestionAnswer.getSpringQuestion().getId();
        answerFlag1 = springQuestionAnswer.getSpringAnswer1().getFlag();
        answerFlag2 = springQuestionAnswer.getSpringAnswer2().getFlag();
        answerFlag3 = springQuestionAnswer.getSpringAnswer3().getFlag();
        answerFlag4 = springQuestionAnswer.getSpringAnswer4().getFlag();
    }
