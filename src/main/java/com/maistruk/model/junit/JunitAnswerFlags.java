...
public class JunitAnswerFlags {
    ...
    public String toString() {
        return "JunitAnswerFlags [id=" + id + ", answerFlag1=" + answerFlag1 + ", answerFlag2=" + answerFlag2
    ...
    public void setFlags(JunitQuestionAnswer questionAnswer) {
