...
public class GitAnswerFlags {
    ...
    public String toString() {
        return "GitAnswerFlags [id=" + id + ", answerFlag1=" + answerFlag1 + ", answerFlag2=" + answerFlag2
    ...
    public void setFlags(GitQuestionAnswer questionAnswer) {
