...
public class MavenAnswerFlags {
    ...
    public String toString() {
        return "MavenAnswerFlags [id=" + id + ", answerFlag1=" + answerFlag1 + ", answerFlag2=" + answerFlag2
    ...
    public void setFlags(MavenQuestionAnswer questionAnswer) {
