...
public class ServletAnswerFlags {
    ...
    public String toString() {
        return "ServletAnswerFlags [id=" + id + ", answerFlag1=" + answerFlag1 + ", answerFlag2=" + answerFlag2
    ...
    public void setFlags(ServletQuestionAnswer questionAnswer) {
